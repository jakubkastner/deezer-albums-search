...
namespace deezer
{
	public class Album
	{
		...
		public void InicializaceAlba(long albumId)
		{
			this.Id = albumId;
			...
			this.CoverNejvetsi = this.CoverNejvetsi.Replace("1000", "1900");
		...
		public class SkladbyAlba
		{
			...
			public SkladbyAlba(long idSkladby, int cisloSkladby, string nazevSkladby, List<string> interpetiAlba)
			{
				this.Id = idSkladby;
